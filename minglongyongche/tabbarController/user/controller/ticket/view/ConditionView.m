...
//        [self addSubview:self.centerButton];
        ...
        self.leftConstarints =  [self.slideLabel autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:(MLWindowWidth/2 - 70)/2];
...
- (UIButton *)leftButton {
    if (!_leftButton) {
        ...
        [_leftButton addAction:^(UIButton *btn) {
            ...
            weakself.leftConstarints.constant = (MLWindowWidth/2-70)/2;
...
- (UIButton *)rightButton {
    if (!_rightButton) {
        ...
        [_rightButton addAction:^(UIButton *btn) {
            ...
            weakself.leftConstarints.constant = MLWindowWidth/2 + (MLWindowWidth/2-70)/2;
