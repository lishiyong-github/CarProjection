...
- (void) setupMyOrderdetailTableViewWithResponse:(MyOrderDetailResponse *)response {
    ...
    //process
    MyOrderDetailProcessItem  *item2 = [[MyOrderDetailProcessItem alloc] initWithProcessStatus:orderModel.status];
    ...
    //action
    MyOrderDetailActionItem *item13 = [[MyOrderDetailActionItem alloc] initWithMyOrderStatus:orderModel.status countDownTime:orderModel.times addTime:orderModel.addtime];
